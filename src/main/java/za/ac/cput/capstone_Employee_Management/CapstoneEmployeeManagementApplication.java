...
import za.ac.cput.capstone_Employee_Management.factory.*;
...
import za.ac.cput.capstone_Employee_Management.service.impl.LeaveServiceImpl;
...
import za.ac.cput.capstone_Employee_Management.service.impl.employeeImpl.EmployeeLeaveServiceImpl;
...
public class CapstoneEmployeeManagementApplication {
   ...
   // @Bean
    ...
    //CommandLineRunner run(EmployeeLeaveServiceImpl employeeLeaveService, EmployeeServiceImpl employeeService, LeaveServiceImpl LeaveService) {
      //  return args -> {
           // Employee emp = EmployeeFactory.build("martinez", "sarafi", "safari");
          //  employeeLeaveService.save(EmployeeLeaveFactory.build(23L, 45L));
          //  employeeLeaveService.save(EmployeeLeaveFactory.build(87L, 30L));
            //employeeLeaveService.save(new EmployeeLeave.Builder().setEmployeeId(3l).setLeaveId(2L).build());
